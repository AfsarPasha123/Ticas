...
export const moveProductToDonation = async (req: Request, res: Response) => {
    try {
...
export const markProductAsDonated = async (req: Request, res: Response) => {
    try {
        const { productIds } = req.body;
...
export const getDonationProducts = async (req: Request, res: Response) => {
    try {
...
export const getDonatedProducts = async (req: Request, res: Response) => {
    try {
        const products = await Product.findAll({
            where: { 
                donation_status: 'donated',
