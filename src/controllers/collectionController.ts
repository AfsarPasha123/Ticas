...
export const getCollectionDetails = async (req: AuthenticatedRequest, res: Response): Promise<Response> => {
  try {
...
export const getCollectionProducts = async (req: AuthenticatedRequest, res: Response): Promise<Response> => {
  try {
    const collection_id = parseInt(req.params.id);
    const owner_id = req.user?.user_id;
...
export const getUserCollections = async (req: AuthenticatedRequest, res: Response): Promise<Response> => {
  try {
    const owner_id = req.user?.user_id;
