...
export const getCollectionDetails = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const getCollectionProducts = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const generateTestCollectionData = async (req: AuthenticatedRequest, res: Response) => {
